...
#  DB에 저장할 최종 컬럼 리스트
FINAL_COLUMNS = [
    'SEASN_NM', 'TRFC_ACDNT_SE_NM', 'ETC_TRFC_ACDNT_NM', 'ACDNT_OCRN_LOT', 
    'ACDNT_OCRN_LAT', 'DCLR_MM', 'SRIL_ONCR_NM', 'PTN_OCRN_TYPE_NM',
    'PTN_SYM_SE_NM', 'ACDNT_OCRN_PLC_NM', 'GRNDS_SGG_NM', 'ACDNT_INJR_NM', 'DCLR_YR'
]
