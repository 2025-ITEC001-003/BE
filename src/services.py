...
# ==================================================================
# AI 기능 임시 비활성화를 위한 Mock(가짜) 함수
# ==================================================================

async def get_agent_response(query: str, session_id: str) -> str:
    """AI 기능을 임시로 비활성화하고 가짜 응답을 반환합니다."""
    print(f"Mock Service: get_agent_response called for session {session_id} with query: {query}")
    return "AI 기능이 임시로 비활성화되었습니다. API 개발을 진행하세요."

async def stream_agent_response(query: str, session_id: str):
    """AI 스트리밍 기능을 임시로 비활성화하고 가짜 응답을 반환합니다."""
    print(f"Mock Service: stream_agent_response called for session {session_id} with query: {query}")
    yield "AI 스트리밍 기능이 임시로 비활성화되었습니다."
